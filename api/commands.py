...
def create_images():
  ...
  three = Image(favorite=False, image_url="https://images.unsplash.com/photo-1548266652-99cf27701ced?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=800&q=60", language='Spanish', text="sky", translated_text="cielo", user_id="123")
